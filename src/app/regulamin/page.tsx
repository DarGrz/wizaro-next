      ...
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-10 space-y-8 border border-gray-100">
        ...
        <section id="cennik">
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-800">
            ...
            <li>Usunięcie pojedynczej opinii: 299 zł brutto. Usługa obejmuje działania prowadzące do usunięcia opinii, za które płatność następuje po ich skutecznym wykonaniu, oraz sporządzenie i dostarczenie raportu końcowego potwierdzającego podjęte czynności. Raport zostanie przesłany po otrzymaniu płatności. <strong>Uwaga: Przy zleceniu usuwania opinii, każda opinia jest rozliczana z osobna. Cena dotyczy jednej opinii.</strong></li>
