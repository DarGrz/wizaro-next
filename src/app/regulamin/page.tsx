    ...
    <div className="max-w-5xl mx-auto py-12 px-4">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-10 space-y-8 border border-gray-100">
        ...
        <section id="cennik">
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-800">
            <li>Usunięcie wizytówki z Google Maps: 1299 zł brutto. Usługa obejmuje działania prowadzące do usunięcia profilu, za które płatność następuje po ich skutecznym wykonaniu, oraz sporządzenie i dostarczenie raportu końcowego potwierdzającego podjęte czynności. Raport zostanie przesłany po otrzymaniu płatności.</li>
            <li>Usunięcie opinii z GoWork: 699 zł brutto. Usługa obejmuje działania prowadzące do usunięcia opinii, za które płatność następuje po ich skutecznym wykonaniu, oraz sporządzenie i dostarczenie raportu końcowego potwierdzającego podjęte czynności. Raport zostanie przesłany po otrzymaniu płatności.</li>
            <li>Usunięcie opinii z portali Aleo, Panorama Firm, PKT, Wenet: 699 zł brutto. Usługa obejmuje działania prowadzące do usunięcia opinii, za które płatność następuje po ich skutecznym wykonaniu, oraz sporządzenie i dostarczenie raportu końcowego potwierdzającego podjęte czynności. Raport zostanie przesłany po otrzymaniu płatności.</li>
