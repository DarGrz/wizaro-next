...
import PrintButtons from '../generate-poa/components/PrintButtons';
  ...
  return (
    <main className="max-w-4xl mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">📋 Pełnomocnictwo - Aleo.com</h1>
      ...
      <div className="bg-white shadow rounded-xl p-8 mb-8 print:shadow-none print:p-0" id="poa-document">
        ...
        <div className="space-y-6 text-justify">
          ...
          <p>
            ...
            z portalu Aleo.com, w tym w szczególności do:
          </p>

          <ul className="list-disc pl-12 space-y-2">
            <li>występowania w moim imieniu w kontaktach z administratorem portalu Aleo.com,</li>
