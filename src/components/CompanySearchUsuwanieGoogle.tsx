...
export default function CompanySearchUsuwanieGoogle() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-4 py-4 sm:py-16">
        <motion.div variants={fadeInUp} className="text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-3xl md:text-6xl font-bold text-[#002a5c] mb-4 sm:mb-6 leading-tight px-4 mt-15">
            Potrzebujesz pomocy z opiniami w Google?<br />
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed px-4">
            Znajdź profil swojej firmy i usuń szkodliwe opinie wpływające na Twoją reputację w Google.
          </p>
        </motion.div>
              ...
              <div className="p-4 sm:p-8">
                <div className="flex justify-between items-start mb-4 sm:mb-6">
                  <div className="flex-1">
                    ...
                    {selectedPlaceDetails.rating && selectedPlaceDetails.rating >= 4.0 && (
                      <div className="mb-4 sm:mb-6 p-4 sm:p-6 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 rounded-lg">
                        <div className="flex items-start">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-green-800 mb-2">
                              Dobra ocena - Usuń pojedyncze negatywne opinie!
                            </h3>
                            <p className="text-green-700 text-sm sm:text-base mb-2">
                              Twoja firma ma dobrą ocenę {selectedPlaceDetails.rating.toFixed(1)}/5.0. Jednak nawet pojedyncze negatywne opinie mogą zaszkodzić Twojej reputacji.
                            </p>
                            <p className="text-green-600 text-sm">
                              Usuń szkodliwe recenzje, aby utrzymać doskonały wizerunek w Google.
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          <div className="bg-gradient-to-br from-slate-900 via-[#002a5c] to-slate-800 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="px-4 sm:px-8 md:px-16 py-8 sm:py-12 md:py-16 text-center border-b border-slate-600/30">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed font-light px-4">
                Wybierz Odpowiednią Usługę dla Twojej Firmy
              </p>
              <p className="text-sm sm:text-lg text-slate-400 mt-3 sm:mt-4 max-w-3xl mx-auto px-4">
                Profesjonalne rozwiązania zarządzania reputacją w Google
              </p>
            </div>
            ...
            <div className="px-4 sm:px-8 md:px-16 py-8 sm:py-12 md:py-16">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                {/* Feature 1 - Usuwanie Opinii */}
                <Link href="/formularz-opinie-google" className="group">
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-full transition-all duration-300 hover:from-white/20 hover:to-white/10 hover:-translate-y-1 hover:shadow-xl cursor-pointer">
                    ...
                    <p className="text-slate-300 leading-relaxed text-center text-xs sm:text-sm mb-3">
                      Usuń fałszywe, niesłuszne lub szkodliwe opinie z Google, które psują reputację Twojej firmy i odstraszają klientów.
                    </p>
                ...
                {/* Feature 2 - Usuwanie Wizytówki */}
                <Link href="/formularz-profil-google" className="group">
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-full transition-all duration-300 hover:from-white/20 hover:to-white/10 hover:-translate-y-1 hover:shadow-xl cursor-pointer">
                    <div className="bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-lg sm:rounded-xl w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-105 transition-transform duration-300">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-slate-300 leading-relaxed text-center text-xs sm:text-sm mb-3">
                      Całkowite usunięcie profilu firmy z Google Maps i wyszukiwarki. Idealne rozwiązanie przy poważnych problemach z reputacją.
                    </p>
                    <div className="text-center">
                ...
                {/* Feature 3 - Resetowanie Wizytówki */}
                <Link href="/formularz-profil-google?reset=true" className="group">
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-full transition-all duration-300 hover:from-white/20 hover:to-white/10 hover:-translate-y-1 hover:shadow-xl cursor-pointer">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-white mb-2 sm:mb-3 text-center">
                      Zresetuj Wizytówkę Google
                    </h3>
                    <p className="text-slate-300 leading-relaxed text-center text-xs sm:text-sm mb-3">
                      Rozpocznij od nowa ze świeżym profilem bez negatywnej historii. Nowa wizytówka z czystą kartą i zerową oceną.
                    </p>
                    <div className="text-center">
                      <span className="text-teal-400 text-sm font-semibold group-hover:text-teal-300 transition-colors">
                        Przejdź do formularza →
                      </span>
                    </div>
                  </div>
