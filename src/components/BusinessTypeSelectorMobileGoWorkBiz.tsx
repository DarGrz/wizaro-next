...
export default function BusinessTypeSelectorMobileGoWork() {
  const [step, setStep] = useState<'start' | 'gowork-type'>('start');
            ...
            >
              <div className="h-[100px] flex flex-col items-center justify-center w-full">
                ...
                <p className="text-gray-600 text-center text-sm sm:text-sm mb-6">
                  Skutecznie usuniemy profil firmy wraz ze wszystkimi opiniami oraz zablokujemy możliwość jego ponownego utworzenia. 
                  Kliknij <strong>START</strong> i wypełnij prosty formularz, resztą zajmiemy się my.
                </p>
                <button
                  onClick={() => setStep('gowork-type')}
