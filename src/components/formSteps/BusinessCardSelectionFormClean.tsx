...
export default function BusinessCardSelectionFormClean({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-2 mt-5 md:mt-0">
      <h2 className="text-2xl md:text-2xl font-bold text-center text-gray-800 mb-3 md:mb-6">
        Wybierz profil Google, z którego chcesz usunąć treści.
      </h2>

      <div className="bg-white mb-2 md:mb-4">        {/* Show selected business card if available */}
        {selectedPlaceDetails && (
          <div className={`mb-4 p-4 ${
            selectedPlaceDetails.rating !== undefined && selectedPlaceDetails.rating < 3.2 
              ? "bg-red-50 border border-red-200" 
              : selectedPlaceDetails.rating !== undefined && selectedPlaceDetails.rating < 3.9 
                ? "bg-yellow-50 border border-yellow-200" 
                : " bg-opacity-10 border border-[#5BA155] border-opacity-20"
          } rounded-lg`}>
            ...
            <a 
              ...
              className="text-[#152856] hover:text-blue-800  text-md font-semibold block mt-1 "
            >
              ...
              <div className="mt-2">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-xs text-gray-500">
                    ({selectedPlaceDetails.user_ratings_total ?? 0} {(selectedPlaceDetails.user_ratings_total === 1 || selectedPlaceDetails.user_ratings_total === 0) ? 'recenzja' : 
                     (selectedPlaceDetails.user_ratings_total ?? 0) < 5 ? 'recenzje' : 'recenzji'})
                  </span>
                </div>
              </div>
            )}{/* Warning message for low ratings */}
            {selectedPlaceDetails.rating !== undefined && selectedPlaceDetails.rating < 3.2 && (
              <div className="mt-3 p-3 bg-red-50 text-sm">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="font-medium text-red-800">Bardzo niska ocena wizytówki</h3>
