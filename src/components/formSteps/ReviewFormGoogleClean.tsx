...
export default function ReviewFormGoogleClean({
  reviews,
  expandedIndex,
  totalPrice,
  businessCardName,
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <h2 className="text-xl font-semibold text-center text-gray-800 mb-2">
        Recenzje do usunięcia z Google Maps
      </h2>
      ...
      {/* Komunikat o wyłączonych recenzjach */}
      {!reviewsEnabled && (
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-orange-800">
                Zbyt duża ilość zgłoszeń na usuwanie recenzji
              </h3>
              <div className="mt-2 text-sm text-orange-700">
                <p>Z powodu dużej ilości zgłoszeń obecnie nie przyjmujemy nowych zleceń na usuwanie pojedynczych recenzji.</p>
                <p className="mt-2 font-medium">Proponujemy usunięcie całej Wizytówki Google lub zresetowanie wszystkich recenzji.</p>
      ...
      {/* Lista recenzji - wyblurowana gdy wyłączone */}
          ...
          >
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-700">
                <p className="font-medium">
                  Recenzja #{index + 1} {review.author && `– ${review.author}`}
                </p>
            ...
            {expandedIndex === index && (
              <>
                ...
                <input
                  type="date"
                  placeholder="Data dodania recenzji"
      ...
      <p className="text-sm text-center text-gray-700">
        Dodaj autora i datę recenzji w celu dokładnej weryfikacji.
      </p>
      <p className="text-sm text-center text-gray-700">
