            ...
            <ul className="mb-4 space-y-2">
              ...
              <div className="flex flex-row sm:flex-row gap-4">
                <Link href="/formularz-opinie-google">
                  <button className="bg-[#002a5c] text-white px-6 py-3 rounded-lg text-sm  font-medium hover:bg-blue-800 transition flex items-center justify-center">
                ...
                <Link href="/formularz-opinie">
                  <button className="bg-[#002a5c] text-white text-sm px-6 py-3 rounded-lg font-medium hover:bg-blue-800 transition flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
