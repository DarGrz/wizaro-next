export default function CompanyReviewRemovalFormExplenation() {
    return (
      <section className="text-gray-800 p-4 rounded-xl max-w-2xl mx-auto text-sm">
        <div className="text-xl sm:text-md text-center font-semibold border-b border-gray-200 rounded p-4 mb-4">
          Wprowadź dane firmy, aby przygotować wniosek o usunięcie opinii. Dane kontaktowe i adresowe są potrzebne do prawidłowej identyfikacji profilu.
        </div>
