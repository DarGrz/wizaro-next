...
export default function ReviewRemovalSummaryExplenationClean() {
  return (
    <section className="text-gray-800 p-4 rounded-xl max-w-2xl mx-auto text-sm">
      ...
      <ol className="space-y-3">
        ...
        {/* Krok 2 */}
        <li className="bg-white p-3">
          <p className="font-medium mb-1">2. Sprawdź zgłoszone recenzje</p>
          <p className="text-gray-700">
            Na liście widnieją wszystkie recenzje zgłoszone do usunięcia. W razie potrzeby możesz wrócić i edytować dane.
          </p>
        </li>
        ...
        <li className="bg-white p-3">
          ...
          <p className="text-gray-700">
           Recenzje zgłoszone do usunięcie od razu trafiają do realizacji, Ty już nic nie musisz robić. 
          </p>
        </li>
      </ol>
    </section>
